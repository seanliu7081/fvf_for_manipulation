...
from fvf.model.diffusion.positional_embedding import SinusoidalPosEmb
...
class TransformerForDiffusion(ModuleAttrMixin):
    def __init__(
        ...
        if num_obs_steps is None:
            num_obs_steps = horizon
