""" drone_rd_image_runner.py - Runner for image-based drone policy evaluation - RD version """
...
from fvf.env.drone.go_to_target_rd_env import GoToTargetRdEnv
...
class DroneRdImageRunner(BaseRunner):
    ...
    def __init__(
        ...
        if env == "go_to_target":
            self.env_class = GoToTargetRdEnv
