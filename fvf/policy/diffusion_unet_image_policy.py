...
from fvf.policy.base_policy import BaseImagePolicy
...
from fvf.model.diffusion.multi_img_obs_encoder import MultiImageObsEncoder
...
class DiffusionUnetImagePolicy(BaseImagePolicy):
    def __init__(self, 
        ...
        if obs_as_global_cond:
            ...
            global_cond_dim = obs_feature_dim * num_obs_steps
    ...
    def get_action(self, obs_dict: Dict[str, torch.Tensor], device, mode='train') -> Dict[str, torch.Tensor]:
        """
        ...
        if self.obs_as_global_cond:
            ...
            nobs_features = self.obs_encoder(this_nobs, mode=mode)
